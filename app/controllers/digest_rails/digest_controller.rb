...
module DigestRails
  class DigestController < Pane::MainController
    ...
    def stylesheet_link_tag(regular, hash={})
      self.view_context.stylesheet_link_tag(regular, hash)
    end

    def javascript_include_tag(regular, hash={})
      self.view_context.javascript_include_tag(regular, hash)
    end
